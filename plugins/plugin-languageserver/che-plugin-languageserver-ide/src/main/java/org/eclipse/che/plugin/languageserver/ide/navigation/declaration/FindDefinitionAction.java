...
public class FindDefinitionAction extends AbstractPerspectiveAction {
    ...
    @Inject
    public FindDefinitionAction(EditorAgent editorAgent, OpenLocationPresenterFactory presenterFactory, TextDocumentServiceClient client,
                                LanguageServerRegistry registry, DtoBuildHelper dtoBuildHelper) {
