...
public class LanguageServerFormatter implements ContentFormatter {
    ...
    @Inject
    public LanguageServerFormatter(TextDocumentServiceClient client, LanguageServerRegistry registry, DtoFactory dtoFactory,
                                   NotificationManager manager, EditorPropertiesManager editorPropertiesManager) {
        this.client = client;
